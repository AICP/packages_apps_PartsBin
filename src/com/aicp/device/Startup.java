...
public class Startup extends BroadcastReceiver {
    ...
    public static void restoreAfterUserSwitch(Context context) {
        ...
        String mHBMOffvalue;
        mHBMOffvalue = context.getResources().getString(R.string.hbmOFF);
        Settings.System.putInt(resolver, HBMModeSwitch.SETTINGS_KEY, Integer.parseInt(mHBMOffvalue));
        restore(HBMModeSwitch.getFile(context), mHBMOffvalue);
