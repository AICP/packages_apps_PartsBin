...
public class Startup extends BroadcastReceiver {
    ...
    public static void restoreAfterUserSwitch(Context context) {
        ...
        restore(VibratorSystemStrengthPreference.getFile(context), Settings.System.getString(resolver,
                      VibratorSystemStrengthPreference.SETTINGS_KEY));
        restore(VibratorNotifStrengthPreference.getFile(context), Settings.System.getString(resolver,
                      VibratorNotifStrengthPreference.SETTINGS_KEY));
        restore(VibratorCallStrengthPreference.getFile(context), Settings.System.getString(resolver,
