...
public class EarpieceGainPreference extends Preference implements
    ...
    public static final String SETTINGS_KEY = DeviceSettings.KEY_SETTINGS_PREFIX + DeviceSettings.KEY_EARPIECE_GAIN;
    ...
    public static String getValue(Context context) {
        ...
        String val = Utils.getFileValueSimple(FILE_LEVEL, DEFAULT_VALUE);
        return val;
    }
